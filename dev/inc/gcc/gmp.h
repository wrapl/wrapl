...
#define __GMP_CC "gcc"
#define __GMP_CFLAGS "-pipe -pipe -O3 -fomit-frame-pointer -D_GNU_SOURCE -fexpensive-optimizations -DLINUX -fdata-sections -ffunction-sections -Wstrict-aliasing -fno-pic -ftls-model=global-dynamic -O2"
