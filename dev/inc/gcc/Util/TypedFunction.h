...
#define TYPED_FUNCTION(RETURN, NAME, PARAMS...)\
	...
	Util$TypedFunction_t __concat(__typedfn, __LINE__) __asmify(NAME) = {\
		{0x53, 0x8B, 0x44, 0x24, 0x08, 0x8B, 0x18, 0x8B, 0x5B, 0x04, 0x8B, 0x0B, 0x83, 0xC3, 0x04, 0x89, 0xCA,\
		 0x89, 0xC8, 0xC1, 0xCA, 0x04, 0x8D, 0x44, 0x50, 0x01, 0x25, 0x01, 0x00, 0x00, 0x00, 0x39, 0x0C, 0xC5},\
		&__concat(__typedfn, __LINE__)._Part4,\
		{0x72, 0xE2, 0x77, 0xEC, 0x5B, 0xFF, 0x24, 0xC5},\
		&__concat(__typedfn, __LINE__)._Part5,\
		{0x90, 0x90, 0x01, 0x00, 0x00, 0x00},\
		0, 0,\
		{0, (void *)&__concat(__invoke, __LINE__), 0, 0, 0, 0}\
	};\
	static RETURN __concat(__invoke, __LINE__)(PARAMS)
