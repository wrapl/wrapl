...
RIVA_CFUN(Riva$Module$t *, load, const char *, const char *);
RIVA_CFUN(Riva$Module$t *, load_file, const char *, const char *);

RIVA_CFUN(void, refresh, Riva$Module$t *);

RIVA_CFUN(const char *, get_path, Riva$Module$t *);
RIVA_CFUN(const char *, get_name, Riva$Module$t *);
RIVA_CFUN(int, import, Riva$Module$t *, const char *, int *, void **);
RIVA_CFUN(int, lookup, void *, const char **, const char **);

RIVA_CFUN(int, suggest, Riva$Module$t *, const char *, Riva$Module$suggest_callback *, void *);

RIVA_CFUN(Riva$Module$t *, new, const char *);
RIVA_CFUN(void, add_alias, Riva$Module$t *, const char *);
RIVA_CFUN(void, set_path, Riva$Module$t *, const char *);
RIVA_CFUN(void, export, Riva$Module$t *, const char *, int , void *);
...
RIVA_CFUN(int, get_version, Riva$Module$t *);
RIVA_CFUN(void, set_version, Riva$Module$t *, int);
