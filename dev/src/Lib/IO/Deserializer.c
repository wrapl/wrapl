...
static Std$Function$status deserialize_riva(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, Std$Object$t *Function) {
...
static Std$Function$status deserializer_read(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result) {
	size_t Index = 0;
...
static Std$Function$status deserialize_nil(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
...
static Std$Function$status deserialize_small(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	int32_t Value;
...
static Std$Function$status deserialize_real(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	double Value;
...
static Std$Function$status deserialize_string(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	size_t Length;
...
static Std$Function$status deserialize_list(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	int Length;
	if (IO$Stream$read(Stream, (char *)&Length, 4, 1) != 4) {
		Result->Val = (Std$Object_t *)IO$Stream$ReadMessage;
		return MESSAGE;
...
static Std$Function$status deserialize_table(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	int Length;
	if (IO$Stream$read(Stream, (char *)&Length, 4, 1) != 4) {
		Result->Val = (Std$Object_t *)IO$Stream$ReadMessage;
		return MESSAGE;
...
static Std$Function$status deserialize_symbol(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	size_t Length;
	if (IO$Stream$read(Stream, (char *)&Length, 4, 1) != 4) {
		Result->Val = (Std$Object_t *)IO$Stream$ReadMessage;
		return MESSAGE;
...
static Std$Function$status deserialize_big(deserializer_t *Deserializer, IO$Stream$t *Stream, Std$Function_result *Result, void *Data) {
	int Count;
...
GLOBAL_FUNCTION(New, 0) {
	Result->Val = (Std$Object_t *)deserializer_new();
	return SUCCESS;
};
