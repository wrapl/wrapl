...
Gtk$GObject$Closure_t *_from_val(Std$Object$t *Function) {
...
Gtk$GObject$Closure_t *_from_ref(Std$Object$t **Function) {
...
GLOBAL_FUNCTION(New, 1) {
	Result->Val = (Std$Object$t *)_from_val(Args[0].Val);
	return SUCCESS;
};
